...
#def login():
    admin_users = [
    {"username": "Douglas", "password": "!Douglas@657657"},
    {"username": "Alex", "password": "!Alex@657657"},
    {"username": "Lucas", "password": "!Lucas@657657"}
]
    if request.method == "POST":
        username = request.form.get("username")
        password = request.form.get("password")

        # Verifica se as credenciais correspondem a um usuário administrador
    ...
    # Método GET, exibir página de login
